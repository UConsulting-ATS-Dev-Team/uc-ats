...
// the door.
//
// The database is __fixtures__/fakeDb.js, an in-memory stand-in that enforces
// the same unique keys as the migration, so "re-ingesting changes nothing" and
// "a person counts once" are checked against constraints rather than against
