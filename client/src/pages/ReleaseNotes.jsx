...
const READ_STORAGE_KEY = 'releaseNotesRead';
const NEW_CUTOFF_DAYS = 14;
...
export default function ReleaseNotes() {
  ...
  const isUnreadNew = (note) => {
    ...
    return isWithinDays(note.releaseDate, NEW_CUTOFF_DAYS);
  };
        ...
        >
          <Box>
            ...
            <Typography variant="body1" color="text.secondary">
              Release notes and updates for the ATS
            </Typography>
          </Box>
          <Button
            variant="outlined"
        ...
        {!loading && !error && notes.length === 0 && (
          <Paper sx={{ p: 4, textAlign: 'center' }} role="status" aria-live="polite">
            ...
            <Typography variant="body2" color="text.secondary">
              Check back later for updates about the ATS.
            </Typography>
          </Paper>
        )}
